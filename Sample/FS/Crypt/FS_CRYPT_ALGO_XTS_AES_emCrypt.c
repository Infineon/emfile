...
File    : FS_CRYPT_ALGO_XTS_AES_emCrypt.c
...
static void _XTS_AES128_Prepare(void * pContext, const U8 * pKey) {
  FS_CRYPT_ALGO_CONTEXT_XTS_AES128_EMCRYPT * pCryptContext;
  unsigned                                   KeyLen;
  U32                                      * pKeyData;
  U32                                      * pKeyIV;

  pCryptContext = (FS_CRYPT_ALGO_CONTEXT_XTS_AES128_EMCRYPT *)pContext;
...
static void _XTS_AES128_Encrypt(void * pContext, U8 * pDest, const U8 * pSrc, U32 NumBytes, U32 BlockIndex) {
  ...
  pKeyData      = pCryptContext->aKeyData;
  pKeyIV        = pCryptContext->aKeyIV;
  CRYPTO_XTS_AES_Encrypt(pDest, (U64)BlockIndex, pSrc, NumBytes, SEGGER_PTR2PTR(const U8, pKeyData), SEGGER_PTR2PTR(const U8, pKeyIV), KeyLen);
}
...
static void _XTS_AES128_Decrypt(void * pContext, U8 * pDest, const U8 * pSrc, U32 NumBytes, U32 BlockIndex) {
  ...
  pKeyData      = pCryptContext->aKeyData;
  pKeyIV        = pCryptContext->aKeyIV;
  CRYPTO_XTS_AES_Decrypt(pDest, (U64)BlockIndex, pSrc, NumBytes, SEGGER_PTR2PTR(const U8, pKeyData), SEGGER_PTR2PTR(const U8, pKeyIV), KeyLen);
}
...
static void _XTS_AES256_Prepare(void * pContext, const U8 * pKey) {
  FS_CRYPT_ALGO_CONTEXT_XTS_AES256_EMCRYPT * pCryptContext;
  unsigned                                   KeyLen;
  U32                                      * pKeyData;
  U32                                      * pKeyIV;

  pCryptContext = (FS_CRYPT_ALGO_CONTEXT_XTS_AES256_EMCRYPT *)pContext;
  pKeyData      = pCryptContext->aKeyData;
  pKeyIV        = pCryptContext->aKeyIV;
  KeyLen        = 32;
  FS_MEMCPY(pKeyData, pKey,          KeyLen);
...
/*********************************************************************
*
*       FS_CRYPT_ALGO_XTS_AES128_emCrypt
*
*  Description
*    Encryption algorithm using XTS-AES with a 128-bit key.
*/
const FS_CRYPT_ALGO_TYPE FS_CRYPT_ALGO_XTS_AES128_emCrypt = {
  _XTS_AES128_Prepare,
  _XTS_AES128_Encrypt,
  _XTS_AES128_Decrypt,
  128
...
/*********************************************************************
*
*       FS_CRYPT_ALGO_XTS_AES256_emCrypt
*
*  Description
*    Encryption algorithm using XTS-AES with a 256-bit key.
*/
const FS_CRYPT_ALGO_TYPE FS_CRYPT_ALGO_XTS_AES256_emCrypt = {
  _XTS_AES256_Prepare,
  _XTS_AES256_Encrypt,
  _XTS_AES256_Decrypt,
  128
