...
File    : FS_CRYPT_ALGO_Scramble.h
Purpose : Scrambling algorithm for the emFile encryption logical driver.
*/

#ifndef FS_CRYPT_ALGO_SCRAMBLE_H    // Avoid multiple inclusion.
#define FS_CRYPT_ALGO_SCRAMBLE_H
...
**********************************************************************
*/
extern const FS_CRYPT_ALGO_TYPE FS_CRYPT_ALGO_Scramble;
